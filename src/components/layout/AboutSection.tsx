      ...
      <motion.div variants={bounceVariant}>
        ...
        >
          ...
          <div className='about-image-container relative mt-8 flex h-[260px] w-auto before:h-[142px] before:w-[142px] sm:h-[396px] sm:before:h-[258px] sm:before:w-[258px] lg:mt-0 lg:w-[396px]'>
            ...
            <div className='animate-rot-react-xs sm:animate-rot-react bg-about-logo-gradient absolute left-[13%] top-[45%] z-[2] m-auto flex h-[26px] w-[26px] items-center justify-center rounded-full border-[0.44px] border-[rgba(255,255,255,0.25)] backdrop-blur-lg sm:h-[46px] sm:w-[46px] md:left-[11%]'>
            ...
            <div className='animate-rot-node-xs sm:animate-rot-node bg-about-logo-gradient absolute left-[35%] top-[80%] z-[2] m-auto flex h-[26px]  w-[26px] items-center justify-center rounded-full border-[0.44px] border-[rgba(255,255,255,0.25)] backdrop-blur-lg sm:h-[46px] sm:w-[46px] md:left-[20%]'>
